...
const useStyles = makeStyles((theme) => ({
  ...
  image: {
    backgroundImage: 'url(https://d3i6fh83elv35t.cloudfront.net/static/2019/08/GettyImages-870035748-1200x801.jpg)',   
    ...
    <Grid container component="main" className={classes.root}>
      ...
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
        ...
        <RegistrationForm reg={reg} regSwitch={regSwitch}/>
          <Avatar className={classes.avatar}  style={{ display: reg ? 'none':'flex'}} >
            <LockOutlinedIcon />
          </Avatar>
          <Typography component="h1" variant="h5" style={{ paddingBottom: 25, display: reg ? 'none' : 'block' }} >
            Sign in
          </Typography>
          <Form
